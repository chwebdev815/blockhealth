...
!function (t) {
    t.fn.jRate = function (o) {
        ...
        function n(t) {
            if (!r(t) || t < M.min || t > M.max)
                throw t + " is not in range(" + min + "," + max + ")";
            M.rating = t, l(t)
        }
        ...
        function C() {
            ...
            for (o = 0; o < M.count; o++)
                _.append(a(o + 1));
            for (z = _.find("svg"), o = 0; o < M.count; o++)
                t = z.eq(o), c(t, o + 1), M.horizontal ? t.css("margin-right", M.shapeGap || "0px") : t.css({
                    display: "block",
