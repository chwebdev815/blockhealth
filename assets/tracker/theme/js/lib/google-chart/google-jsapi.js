...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        var x = /^[\w+/]+[=]{0,2}$/, y = function (a) {
            if ((a = (a || g).document.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && x.test(a))
                return a
        };
        function z(a) {
        ...
        google.load = function (a, b, c) {
            ...
            if (a = H[":" + e]) {
                ...
                if ((f = c && null != c.callback) && !a.D(b))
                    throw E("Module: '" + e + "' must be loaded before DOM onLoad!");
                f ? a.u(b, c) ? window.setTimeout(c.callback, 0) : a.load(b, c) : a.u(b, c) || a.load(b, c)
            } else
                throw E("Module: '" + e + "' not found!");
        };
        ...
        google.loader.f = function (a, b, c) {
            if (c) {
                if ("script" == a) {
                    ...
                    "css" == a && (d = document.createElement("link"), d.type = "text/css", d.href = b, d.rel = "stylesheet");
                (a = document.getElementsByTagName("head")[0]) || (a = document.body.parentNode.appendChild(document.createElement("head")));
                a.appendChild(d)
            } else
                "script" == a ? (a = '<script src="' + w(b) + '" type="text/javascript"', (d = y()) && (a += ' nonce="' + w(d) + '"'), document.write(a + ">\x3c/script>")) : "css" == a &&
        ...
        google.loader.ba = function (a) {
            for (var b in a)
                "string" == typeof b && b && ":" == b.charAt(0) && !H[b] && (H[b] = new O(b.substring(1), a[b]))
        };
        ...
        P.prototype.load = function (a, b) {
            var c, d = this.H(b), e = b && null != b.callback;
            ...
            if (d.length) {
                ...
                for (h = 0; h < f.length; h++)
                    k = f[h], this.g[":" + k] = [], e && this.g[":" + k].push(c);
                if (b || null == I[":" + this.b] || null == I[":" + this.b].versions[":" + a] || google.loader.AdditionalParams || !this.s)
        ...
        O.prototype.i = function (a, b) {
            if (!this.h.versions[":" + a]) {
                ...
                if (!this.h.versions[":" + a])
                    throw E("Module: '" + this.b + "' with version '" + a + "' not found!");
            }
        ...
        var U = !1, V = [], ba = (new Date).getTime(), X = function () {
