...
class MessageInteractionList extends ListResource {
    ...
    public function create($options = array()) {
        ...
        return new MessageInteractionInstance(
                $this->version, $payload, $this->solution['serviceSid'], $this->solution['sessionSid'], $this->solution['participantSid']
        );
    }
    ...
    public function getContext($sid) {
        return new MessageInteractionContext(
                $this->version, $this->solution['serviceSid'], $this->solution['sessionSid'], $this->solution['participantSid'], $sid
        );
    }
