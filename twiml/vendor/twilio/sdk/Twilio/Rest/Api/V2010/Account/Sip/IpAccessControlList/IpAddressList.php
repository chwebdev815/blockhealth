...
class IpAddressList extends ListResource {
    ...
    public function create($friendlyName, $ipAddress, $options = array()) {
        ...
        return new IpAddressInstance(
                $this->version, $payload, $this->solution['accountSid'], $this->solution['ipAccessControlListSid']
        );
    }
    ...
    public function getContext($sid) {
        return new IpAddressContext(
                $this->version, $this->solution['accountSid'], $this->solution['ipAccessControlListSid'], $sid
        );
    }
