...
class AssignedAddOnContext extends InstanceContext {
    ...
    public function fetch() {
        ...
        return new AssignedAddOnInstance(
                $this->version, $payload, $this->solution['accountSid'], $this->solution['resourceSid'], $this->solution['sid']
        );
    }
    ...
    protected function getExtensions() {
        if (!$this->_extensions) {
            $this->_extensions = new AssignedAddOnExtensionList(
                    $this->version, $this->solution['accountSid'], $this->solution['resourceSid'], $this->solution['sid']
            );
        }
