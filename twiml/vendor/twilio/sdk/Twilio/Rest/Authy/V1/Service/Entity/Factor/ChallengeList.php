...
class ChallengeList extends ListResource {
    ...
    public function create($options = array()) {
        ...
        return new ChallengeInstance(
                $this->version, $payload, $this->solution['serviceSid'], $this->solution['identity'], $this->solution['factorSid']
        );
    }
    ...
    public function getContext($sid) {
        return new ChallengeContext(
                $this->version, $this->solution['serviceSid'], $this->solution['identity'], $this->solution['factorSid'], $sid
        );
    }
