...
class Mail implements \JsonSerializable {
    ...
    $cc, $name = null, $personalizationIndex = null, $personalization = null
    ) {
        if ($cc instanceof Cc) {
            $name = $cc->getName();
        ...
        $this->addRecipientEmail(
                "Cc", $cc, $name, $personalizationIndex, $personalization
        );
    }
    ...
    $bcc, $name = null, $personalizationIndex = null, $personalization = null
    ) {
        ...
        $this->addRecipientEmail(
                "Bcc", $bcc, $name, $personalizationIndex, $personalization
        );
    }
