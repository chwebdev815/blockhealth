...
class StatsTest extends BaseTestClass {
    ...
    $expectedGlobal, $expectedCategory, $expectedSubuser, $expectedSum, $expectedSubuserMonthly
    ) {
        ...
        $this->assertEquals($expectedSum, $userStats->getSum(
                        $expectedSum['sort_by_metric'], $expectedSum['sort_by_direction'], $expectedSum['limit'], $expectedSum['offset']
        ));
        $this->assertEquals($expectedSubuserMonthly, $userStats->getSubuserMonthly(
                        $expectedSubuserMonthly['subuser'], $expectedSubuserMonthly['sort_by_metric'], $expectedSubuserMonthly['sort_by_direction'], $expectedSubuserMonthly['limit'], $expectedSubuserMonthly['offset']
        ));
    }
