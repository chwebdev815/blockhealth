...
<div class="card mb-3">
    <div class="card-header">
        ...
        Clinics Statistics</div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="table_clinic_statistics" class="table table-bordered table-responsive table-striped" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>Clinic Name</th>
                        <th>Signup Date</th>
                        <th>Physicians Added</th>
                        <th>New Referrals</th>
                        <th>Referrals Accepted</th>
                        <th>Referrals Scheduled</th>
                        <th>Visits confirmed</th>
                        <th>Faxes sent</th>
                        <th>Demographic API</th>
                        <th>Clinical API</th>
                        <th>Physician API</th>
                        <th>Datapoints Captured</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
