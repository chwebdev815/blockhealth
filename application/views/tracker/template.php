...
<html lang="en">
    <head>
        ...
        <link href="<?php echo tracker_assets(); ?>vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <a class="navbar-brand mr-1" href="index.html">Blockhealth Tracker</a>
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>admin_dashboard" id="li_dashboard">
                        <i class="fas fa-fw fa-hospital"></i>
                        <span>Clinics</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>admin_dashboard_cp" id="li_dashboard_cp">
                        <i class="fas fa-fw fa-user-md"></i>
                        <span>Clinic Physicians</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>admin_dashboard_rp" id="li_dashboard_rp">
                ...
                <footer class="sticky-footer">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright © Blockhealth 2018</span>
                        </div>
                    </div>
                </footer>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url(); ?>admin_login/logout">Logout</a>
                    </div>
                </div>
            </div>
        </div>
        <?php
        echo form_open("#", array('id' => 'form_common'));
        echo form_hidden('id', '');
        echo form_hidden('target', '');
        echo form_hidden('param', '');
        echo form_close();
        ?>
        ...
        <script src="<?php echo tracker_assets(); ?>js/sb-admin.min.js"></script>
